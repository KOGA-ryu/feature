...
QString textEditorWorkbenchQss() {
    return QString(R"(
        ...
        QFrame#textEditorCommandPaletteResults {
            background: transparent;
            border: 0;
        }
        QFrame#textEditorCommandPaletteRow {
            background: #ffffff;
            color: #1f2933;
            border: 0;
            border-radius: 0;
        ...
        QLabel#textEditorCommandPaletteRowText {
            color: #1f2933;
            font-size: 11px;
            font-weight: 600;
        }
        QFrame#textEditorCommandPaletteRow:hover,
        QFrame#textEditorCommandPaletteRow[componentState="selected"] {
            background: #eaf3ff;
        }
        QFrame#textEditorCommandPaletteRow:hover QLabel#textEditorCommandPaletteRowText,
        QFrame#textEditorCommandPaletteRow[componentState="selected"] QLabel#textEditorCommandPaletteRowText {
            color: #12395c;
        }
        QFrame#textEditorCommandPaletteRow[componentState="disabled"] {
            background: #f5f7f9;
        }
        QFrame#textEditorCommandPaletteRow[componentState="disabled"] QLabel#textEditorCommandPaletteRowText {
            color: #7b8794;
        }
